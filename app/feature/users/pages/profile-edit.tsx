...
interface MyPageProps {
    ...
    onUpdateProfile: (username: string, profileUrl: string) => void;
}
...
export default function profileEdit({
    ...
    const handleSave = () => {
        onUpdateProfile(editUsername, editProfileUrl);
        setIsEditing(false);
    };
                    ...
                    <CardContent className="p-6">
                        <div className="flex flex-col items-center space-y-4 md:flex-row md:space-x-6 md:space-y-0">
                            <Avatar className="h-20 w-20 md:h-24 md:w-24">
                                <AvatarImage src={userProfile.profile_url || undefined} alt={userProfile.username}/>
                            ...
                            <div className="flex-1 text-center md:text-left">
                                <div className="flex flex-col items-center gap-2 md:flex-row md:gap-4">
                                    <h1 className="ml-1 text-2xl font-bold">{userProfile.username}</h1>
                                ...
                                <p className="ml-1 text-muted-foreground">{userProfile.email}</p>
